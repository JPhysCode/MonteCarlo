...
plot 'water_uranium_macroscopic.dat' using ($1/1e6):2 with lines title 'Water (H2O) at 4°C' lc rgb 'blue' lw 2, \
     'water_uranium_macroscopic.dat' using ($1/1e6):3 with lines title 'Natural Uranium (0.72% U235, 99.28% U238)' lc rgb 'red' lw 2
